...
import 'package:beams_pricecheck/views/components/messageBox/message_box.dart';
      ...
      AlertDialog (
        ...
        content: Container(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              tc("New Version", Colors.black, 13),
              gapHC(3),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  tcn("Updating...", Colors.black, 16),
                  // const CupertinoActivityIndicator(
                  //   animating: true,
                  //   radius: 20,
                  // ),
                  SpinKitFadingFour(color: Color(0xff18253d),size: 30,)
                ],
              ),
            ],
          ),
